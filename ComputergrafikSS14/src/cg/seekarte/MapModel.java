...
public class MapModel
{
    ...
    public MapModel()
    {
        ...
        final double[] calLotsePoint1 =
        { 56, 11, 396, 36 };
        final double[] calLotsePoint2 =
        { 54, 11, 396, 831 };
        final double[] calLotsePoint3 =
        { 54, 14, 1081, 831 };

        // Kalibrierungs Punkte(S09lkarte) als Vektor (L1, B1, x1, y1)
        final double[] calS09lPoint1 =
        { 55.75, 10.67, 711, 424 };
        final double[] calS09lPoint2 =
        { 55.58, 10.67, 859, 1818 };
        final double[] calS09lPoint3 =
        { 55.58, 10.83, 1648, 1734 };

        lotse = new Map(new ImageIcon("res/Seekarte/lotse1.jpg"), calLotsePoint1, calLotsePoint2, calLotsePoint3);
        s09l = new Map(new ImageIcon("res/Seekarte/s09l.jpg"), calS09lPoint1, calS09lPoint2, calS09lPoint3);
        selectedMap = lotse;
    ...
    public void changeSelectedMap(final Map map)
    {
        ...
        {
            final double[] result = Matrix.matMult(getInverseMapTransform(), ds);
