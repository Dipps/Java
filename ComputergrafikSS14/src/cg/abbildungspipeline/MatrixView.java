...
public class MatrixView extends JPanel {
    ...
    public static void main(String[] args) {
        JFrame jf = new JFrame("MatrixView");
        double[][] d = { { 1, 2, 3 }, { 4, 5, 5 }, { 6, 7, 8 } };
        jf.add(new MatrixView(d));
        jf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        jf.setSize(300, 400);
        jf.setVisible(true);

        JFrame jf1 = new JFrame("MatrixView");
        double[][] d1 = { { 6, -7, 8, 9 }, { 1, 2, 3 },
                { 4.4447, -5.4677, 18.456 } };
        MatrixView mv = new MatrixView(3, 4);
        mv.setLabelBorder();
        mv.setDecimals(3);
        mv.setLabelBorder(new LineBorder(Color.cyan, 2));
        mv.setText(10, 10, 1);
        ...
        mv.setLabels(0d);
        mv.setLabels(d1);
        double[][] d2 = { { 677777788, -7, 1, 7, 1, 1, 1 }, { 1, 2, 3 },
                { 4.4447, -5.4677, 18.456 } };
        mv.setLabels(d2);
    }
